...
const FACEMESH_GRAPHMODEL_PATH = `http://localhost:${port}/tensorflowlocal/facemesh_1_default_1`;
...
async function loadMeshModel() {
    return tfconv.loadGraphModel(FACEMESH_GRAPHMODEL_PATH + '/model.json');
